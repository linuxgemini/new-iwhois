...
const getHandleList = () => {
    return new Promise((resolve, reject) => {
        ...
        const req = https.get("https://raw.githubusercontent.com/rfc1036/whois/next/nic_handles_list", r => {
            r.on("data", (chunk) => {
...
const main = async () => {
    /** @type {string} */
    let masterlisttsv = await getHandleList();
    let finale = {};
    ...
    fs.writeFileSync("../nic-handle-list.json", JSON.stringify(finale, null, 4));
};
